const Form = () => {
  return (
    ...
    <div className="flex flex-col">
      <label htmlFor="questions" className="pb-2 font-medium text-xl">Number of questions</label>
      <input
        type="number"
        defaultValue="10"
    ...
    <div className="flex flex-col">
      <label htmlFor="category" className="pb-2 font-medium text-xl">Category</label>
      <select
        name="category"
        id="category"
    ...
    <div className="flex flex-col">
      <label htmlFor="difficulty" className="pb-2 font-medium text-xl">Difficulty</label>
      <select
        name="difficulty"
        id="difficulty"
        className="bg-zinc-50 py-2 pl-1 border border-zinc-700"
